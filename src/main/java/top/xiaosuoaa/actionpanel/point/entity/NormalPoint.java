...
public class NormalPoint extends PointData {
	public static final int COLOR = 0x11FF22;
	private static final PointRunner RUNNER = PointRunnerUtil
			.displayFirstMessage(COLOR, Component.translatable("point.normal.message"))
			.build();

	public NormalPoint() {
		super(
				Component.translatable("point.normal.name"),
				null,
				false,
				COLOR,
				RUNNER,
				false,
				Component.translatable("point.normal.description")
		);
	}
}
