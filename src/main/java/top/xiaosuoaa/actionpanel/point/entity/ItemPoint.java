...
public class ItemPoint extends PointData {
	public static final int COLOR = 0xFFDF26;
	public static final ResourceLocation RES = ResUtil.getRes("textures/gui/custom/point_item.png");
	private static final PointRunner RUNNER = PointRunnerUtil
			.displayFirstMessage(COLOR, Component.translatable("point.item.message"))
			.build();

	public ItemPoint() {
		super(
				Component.translatable("point.item.name"),
				RES,
				true,
				COLOR,
				RUNNER,
				false,
				Component.translatable("point.item.description")
		);
	}
}
