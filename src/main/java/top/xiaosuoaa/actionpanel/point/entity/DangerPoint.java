...
public class DangerPoint extends PointData {
	public static final int COLOR = 0xFF4545;
	public static final ResourceLocation RES = ResUtil.getRes("textures/gui/custom/point_danger.png");
	private static final PointRunner RUNNER = PointRunnerUtil
			.displayFirstMessage(COLOR, Component.translatable("point.danger.message"))
			.build();

	public DangerPoint() {
		super(
				Component.translatable("point.danger.name"),
				RES,
				true,
				COLOR,
				RUNNER,
				false,
				Component.translatable("point.danger.description")
		);
	}
}
