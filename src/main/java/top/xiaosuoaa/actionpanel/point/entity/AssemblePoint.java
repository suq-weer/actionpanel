...
public class AssemblePoint extends PointData {
	public static final int COLOR = 0xFF94DF;
	public static final ResourceLocation RES = ResUtil.getRes("textures/gui/custom/point_assemble.png");
	private static final PointRunner RUNNER = PointRunnerUtil
			.displayFirstMessage(COLOR, Component.translatable("point.assemble.message"))
			.build();

	public AssemblePoint() {
		super(
				Component.translatable("point.assemble.name"),
				RES,
				true,
				COLOR,
				RUNNER,
				false,
				Component.translatable("point.assemble.description")
		);
	}
}
