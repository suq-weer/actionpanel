...
public class MachinePoint extends PointData {
	public static final int COLOR = 0xFF4800;
	public static final ResourceLocation RES = ResUtil.getRes("textures/gui/custom/point_machine.png");
	private static final PointRunner RUNNER = PointRunnerUtil
			.displayFirstMessage(COLOR, Component.translatable("point.machine.message"))
			.build();

	public MachinePoint() {
		super(
				Component.translatable("point.machine.name"),
				RES,
				true,
				COLOR,
				RUNNER,
				false,
				Component.translatable("point.machine.description")
		);
	}
}
