...
public class MovePoint extends PointData {
	public static final int COLOR = 0x639CFF;
	public static final ResourceLocation RES = ResUtil.getRes("textures/gui/custom/point_move.png");
	private static final PointRunner RUNNER = PointRunnerUtil
			.displayFirstMessage(COLOR, Component.translatable("point.move.message"))
			.build();

	public MovePoint() {
		super(
				Component.translatable("point.move.name"),
				RES,
				true,
				COLOR,
				RUNNER,
				false,
				Component.translatable("point.move.description")
		);
	}
}
