...
public class EnemyPoint extends PointData {
	public static final int COLOR = 0xFF4F4F;
	public static final ResourceLocation RES = ResUtil.getRes("textures/gui/custom/point_enemy.png");
	private static final PointRunner RUNNER = PointRunnerUtil
			.displayFirstMessage(COLOR, Component.translatable("point.enemy.message"))
			.build();

	public EnemyPoint() {
		super(
				Component.translatable("point.enemy.name"),
				RES,
				true,
				COLOR,
				RUNNER,
				false,
				Component.translatable("point.enemy.description")
		);
	}
}
